...
In reality, density and temperature are not constant but are function of the radial position in the plasma. During spatial integration in the later derivation, a more realistic profile should have been used. Common radial profiles are parabolic profiles, which can be defined for density and temperature as:
